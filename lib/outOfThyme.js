...
function bindButtons(){
  document.getElementById("getRecipe").addEventListener('click', function(event){
    var recDescript=document.getElementById("recipeDescription");
    var descript= document.createElement('p');
    var descriptTxt=document.createTextNode(testRecipe[0].description);
    descript.appendChild(descriptTxt);
    recDescript.appendChild(descript);
    var recDir=document.getElementById("recipeDirections");
    var direct= document.createElement('p');
    var directTxt=document.createTextNode(testRecipe[0].directions);
    direct.appendChild(directTxt);
    recDir.appendChild(direct);
    var recTime=document.getElementById("recipeTimers");
    var timers= document.createElement('p');
    var timersTxt=document.createTextNode(testRecipe[0].timers);
    timers.appendChild(timersTxt);
    recTime.appendChild(timers);

    /*will use later when db set up
